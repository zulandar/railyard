...
// InspectSession returns the tmux session name for the inspect daemon.
// Format: railyard_OWNER_inspect
func InspectSession(owner string) string {
	return fmt.Sprintf("railyard_%s_inspect", owner)
}
