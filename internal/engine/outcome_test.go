...
func TestHandleCompletion_NilBead(t *testing.T) {
...
func TestHandleCompletion_NilEngine(t *testing.T) {
	err := HandleCompletion(nil, &models.Bead{ID: "be-1"}, nil, CompletionOpts{RepoDir: "/tmp"})
	if err == nil {
...
func TestHandleCompletion_EmptyRepoDir(t *testing.T) {
	err := HandleCompletion(nil, &models.Bead{ID: "be-1"}, &models.Engine{ID: "eng-1"}, CompletionOpts{})
	if err == nil {
...
func TestHandleClearCycle_NilBead(t *testing.T) {
...
func TestHandleClearCycle_NilEngine(t *testing.T) {
	err := HandleClearCycle(nil, &models.Bead{ID: "be-1"}, nil, ClearCycleOpts{Cycle: 1})
	if err == nil {
		t.Fatal("expected error for nil engine")
	}
}
...
func TestHandleClearCycle_ZeroCycle(t *testing.T) {
	err := HandleClearCycle(nil, &models.Bead{ID: "be-1"}, &models.Engine{ID: "eng-1"}, ClearCycleOpts{Cycle: 0})
	if err == nil {
...
func TestHandleClearCycle_NegativeCycle(t *testing.T) {
	err := HandleClearCycle(nil, &models.Bead{ID: "be-1"}, &models.Engine{ID: "eng-1"}, ClearCycleOpts{Cycle: -1})
	if err == nil {
