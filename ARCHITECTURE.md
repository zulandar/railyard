...
| **Engine** | A worker agent backed by a configurable **provider** (Claude Code by default; also supports Codex, Gemini CLI, Copilot) |
...
agent_provider: claude               # default provider for all tracks (claude|codex|gemini|copilot)
...
Built-in providers: **Claude Code** (default), **Codex**, **Gemini CLI**, **Copilot**. New providers can be added by implementing the provider interface.
...
type MergeRequest struct {
    ...
    Priority    int       `gorm:"default:2"`              // P0=Critical, P1=High, P2=Medium, P3=Low, P4=Trivial
