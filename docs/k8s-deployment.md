...
- **Agent credentials** for your chosen AI provider — API keys for Claude/Codex/Gemini, or a GitHub PAT for Copilot (see [k8s-authentication.md](k8s-authentication.md))
