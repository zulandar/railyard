...
4. **Sets priorities** using the P0–P4 enterprise model (P0=Critical, P1=High, P2=Medium, P3=Low, P4=Trivial) — foundation tasks typically get P1, endpoints get P2, integration gets P2. Type defaults: bug→P1, feature→P2, task→P2, spike→P3
